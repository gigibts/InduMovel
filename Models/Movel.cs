...
namespace InduMovel.Models
{
    public class Movel
    {
        ...
        [Display(Name = "Movel")]
        [MinLength(3, ErrorMessage = "Movel deve ter no minino {1} caracteres")]
        [MaxLength(30, ErrorMessage = "Movel deve ter no minimo {1} caracteres")]
        public string Nome { get; set; }

        [Required(ErrorMessage = "Informe o nome da Descrição")]
        [Display(Name = "Descrição")]
        [MinLength(3, ErrorMessage = "Descrição deve ter no minino {1} caracteres")]
        [MaxLength(20, ErrorMessage = "Descrição deve ter no minimo {1} caracteres")]
        ...
        public string ImagemPequeno { get; set; }
        ...
        [Required(ErrorMessage = "Informar a Categoria")]
